...
func RegisterGatewayRoutes(
	...
	forceGrokPlatform := middleware.ForcePlatform(service.PlatformGrok)
	forceGrokV1VideoPath := func(c *gin.Context) {
	...
	gateway.Use(forceGrokV1VideoPath)
	...
	gateway.Use(requireGroupAnthropic)
	{
		...
		gateway.POST("/messages", func(c *gin.Context) {
			dispatchOpenAIResponsesCompatibleGateway(c, h.OpenAIGateway.Messages, h.Gateway.Messages)
		})
		...
		gateway.POST("/responses", func(c *gin.Context) {
			dispatchOpenAIResponsesCompatibleGateway(c, h.OpenAIGateway.Responses, h.Gateway.Responses)
		})
		...
		gateway.POST("/chat/completions", func(c *gin.Context) {
			dispatchOpenAIResponsesCompatibleGateway(c, h.OpenAIGateway.ChatCompletions, h.Gateway.ChatCompletions)
		})
	...
	r.POST("/videos", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, forceGrokPlatform, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, videoGenerationHandler)
	r.POST("/videos/generations", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, forceGrokPlatform, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, videoGenerationHandler)
	r.POST("/videos/edits", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, forceGrokPlatform, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, videoEditHandler)
	r.POST("/videos/extensions", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, forceGrokPlatform, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, videoExtensionHandler)
	r.GET("/videos/generations/:request_id/content", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, forceGrokPlatform, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, videoContentHandler)
	r.GET("/videos/edits/:request_id/content", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, forceGrokPlatform, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, videoContentHandler)
	r.GET("/videos/extensions/:request_id/content", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, forceGrokPlatform, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, videoContentHandler)
	r.GET("/videos/generations/:request_id", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, forceGrokPlatform, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, videoStatusHandler)
	r.GET("/videos/edits/:request_id", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, forceGrokPlatform, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, videoStatusHandler)
	r.GET("/videos/extensions/:request_id", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, forceGrokPlatform, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, videoStatusHandler)
	r.GET("/videos/:request_id", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, forceGrokPlatform, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, videoStatusHandler)
	r.GET("/videos/:request_id/content", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, forceGrokPlatform, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, videoContentHandler)
...
func dispatchOpenAIResponsesCompatibleGateway(c *gin.Context, compatible, native gin.HandlerFunc) {
