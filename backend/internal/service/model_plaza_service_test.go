...
func TestListPlazaGroupsWithModelFallback_AccountPoolModelsAndPricing(t *testing.T) {
	...
	out, err := svc.ListGroupsWithModelFallback(context.Background(), func(group *Group) []string {
...
func TestListPlazaGroupsWithModelFallback_ChannelPricingWins(t *testing.T) {
	...
	svc := newPlazaService([]Channel{channel}, groups, nil)

	out, err := svc.ListGroupsWithModelFallback(context.Background(), func(*Group) []string {
