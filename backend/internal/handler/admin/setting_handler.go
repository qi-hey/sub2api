...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		GameWalletEnabled:                                      settings.GameWalletEnabled,
		GameWalletExchangeRate:                                 settings.GameWalletExchangeRate,
		GameWalletDailyLimit:                                   settings.GameWalletDailyLimit,
		GameLoyaltyEnabled:                                     settings.GameLoyaltyEnabled,
		GameLoyaltyCheckinCredits:                              settings.GameLoyaltyCheckinCredits,
		GameLoyaltySlotBetCredits:                              settings.GameLoyaltySlotBetCredits,
		GameLoyaltyDailyRewardLimit:                            settings.GameLoyaltyDailyRewardLimit,
		GameLoyaltyRewardCatalog:                               settings.GameLoyaltyRewardCatalog,
