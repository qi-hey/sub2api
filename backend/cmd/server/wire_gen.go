...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	gameWalletBalanceCache := service.ProvideGameWalletBalanceCache(billingCache)
	gameLoyaltyService := service.NewGameLoyaltyService(gameLoyaltyRepository, settingService, apiKeyAuthCacheInvalidator, gameWalletBalanceCache)
	...
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, pluginManager, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, grokQuotaService, subscriptionService, configConfig, coordinator)
	...
	modelPlazaHandler := handler.NewModelPlazaHandler(modelPlazaService, apiKeyService, settingService, gatewayService)
