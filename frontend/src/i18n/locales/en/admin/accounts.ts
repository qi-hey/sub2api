export default {
    accounts: {
      ...
      toolActions: 'Tools',
      grokSSOReauth: {
        menu: 'Batch Grok SSO Re-Auth',
        title: 'Batch Grok SSO Re-Authentication',
        upload: 'Upload SSO File',
        tokens: 'SSO cookies',
        placeholder: 'One SSO cookie per line; email:SSO is supported',
        tokenCount: '{count} unique cookie(s)',
        previewRequired: 'Preview matches first; preview does not modify accounts.',
        previewStats: '{executable} ready to apply, {skipped} will be skipped. The real SSO identity is verified again during apply.',
        noApplicable: 'No matched accounts in this preview are eligible for re-authentication.',
        preview: 'Preview Matches',
        previewing: 'Previewing...',
        apply: 'Apply Re-Auth',
        applying: 'Applying...',
        identity: 'SSO Identity',
        target: 'Matched Account',
        action: 'Result',
        resolveConflicts: 'Resolve unmatched or conflicting identities before applying.',
        previewFailed: 'Failed to preview Grok SSO matches',
        applyFailed: 'Failed to apply Grok SSO re-authentication',
        summary: 'Grok SSO re-authentication completed: {updated} updated, {failed} failed, {skipped} skipped',
        actions: {
          update: 'Ready',
          create: 'Create',
          unmatched: 'Unmatched',
      ...
      openai: {
        ...
        codexFingerprintModeDesc: 'New OpenAI OAuth accounts default to account-balanced convergence: each account keeps one stable device and session identity while separate Codex tasks retain independent threads, turns, and cache scopes. Existing accounts without this field remain off and are never force-migrated.',
        codexFingerprintOff: 'Off (passthrough)',
        codexFingerprintDevice: 'Device only',
        codexFingerprintSession: 'Account balanced (recommended)',
        codexFingerprintFull: 'Full convergence (experimental)',
      ...
      oauth: {
        ...
        grok: {
          ...
          convertSSOAndReauth: 'Refresh Existing Accounts',
          uploadSSOFile: 'Upload SSO File',
          ssoReauthSuccess: 'SSO reauth finished: updated {updated}, created {created}, failed {failed}',
          failedToReauthSSO: 'Failed to reauth Grok SSO cookies',
          validating: 'Validating...',
          validateAndCreate: 'Validate & Create Account',
          pleaseEnterRefreshToken: 'Please enter Refresh Token',
