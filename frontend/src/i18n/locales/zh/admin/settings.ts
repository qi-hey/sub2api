      ...
      features: {
        ...
        availableChannels: {
          ...
          enabledHint: '关闭后用户端侧边栏入口隐藏，接口返回空数组。',
	        ...
	        gameLoyalty: {
          title: '游戏积分与奖励',
          description: '配置每日签到积分、老虎机下注积分、每日奖励限额与奖励目录。未正确配置经济参数前功能保持关闭。',
          enabled: '启用游戏积分与奖励',
          enabledHint: '关闭后游戏大厅仍可访问，但签到、积分老虎机与奖励兑换会显示维护状态；其他本地游戏不受影响。',
          checkinCredits: '每日签到积分',
          checkinCreditsHint: '请输入非负整数。启用功能时必须大于 0。',
          checkinCreditsInvalid: '签到积分必须是非负整数，启用时必须大于 0。',
          slotBetCredits: '每次下注积分',
          slotBetCreditsHint: '请输入 0-10000 的整数。启用功能时必须大于 0。',
          slotBetCreditsInvalid: '每次下注积分必须是 0-10000 的整数，启用时必须大于 0。',
          dailyRewardLimit: '每日奖励兑换上限（次数）',
          dailyRewardLimitHint: '每位用户每日可兑换奖励的总次数。填 0 表示不限制。',
          dailyRewardLimitInvalid: '每日奖励上限必须是大于或等于 0 的整数。',
          catalog: '奖励目录',
          catalogHint: '使用表单维护奖励项，保存时自动生成精确 JSON。',
          catalogInvalid: '奖励目录无效，请检查各字段后重试。',
          addReward: '添加奖励',
          removeReward: '删除',
          ...
          expiryDays: '有效天数',
          enabledLabel: '启用',
          emptyCatalog: '暂无奖励项，可添加后保存。',
        },
        // legacy key kept so old tests/messages do not surface raw paths
        gameExchange: {
          title: '游戏积分与奖励',
          description: '配置每日签到积分、老虎机下注积分、每日奖励限额与奖励目录。',
          enabled: '启用游戏积分与奖励',
          enabledHint: '关闭后签到与奖励兑换会显示维护状态。',
          rate: '每日签到积分',
          rateHint: '请输入非负整数；启用时必须大于 0。',
          rateInvalid: '签到积分必须是非负整数，启用时必须大于 0。',
          dailyLimit: '每日奖励兑换上限',
          dailyLimitHint: '填 0 表示不限制。',
	          dailyLimitInvalid: '每日奖励上限必须是大于或等于 0 的整数。',
	        },
	        modelPlaza: {
          title: '模型广场',
