export default {
    accounts: {
      ...
      toolActions: '工具',
      grokSSOReauth: {
        menu: '批量 Grok SSO 重新认证',
        title: '批量 Grok SSO 重新认证',
        upload: '上传 SSO 文件',
        tokens: 'SSO Cookie',
        placeholder: '每行一个 SSO Cookie，支持 email:SSO 格式',
        tokenCount: '共 {count} 个不重复 Cookie',
        previewRequired: '请先预览匹配；预览不会修改账号。',
        previewStats: '可执行 {executable} 个，将跳过 {skipped} 个；执行时会再次校验真实 SSO 身份。',
        noApplicable: '预览中没有可重新认证的已匹配账号。',
        preview: '预览匹配',
        previewing: '正在预览...',
        apply: '执行重新认证',
        applying: '正在执行...',
        ...
        target: '匹配账号',
        action: '结果',
        resolveConflicts: '存在未匹配或冲突项，请处理后再执行。',
        previewFailed: 'Grok SSO 匹配预览失败',
        applyFailed: 'Grok SSO 重新认证失败',
        summary: 'Grok SSO 重新认证完成：更新 {updated} 个，失败 {failed} 个，跳过 {skipped} 个',
        actions: {
          update: '可更新',
          create: '将创建',
          unmatched: '未匹配',
      ...
      openai: {
        ...
        codexFingerprintModeDesc: '新建 OpenAI OAuth 账号默认使用账号级平衡模式：每个账号保持独立设备与会话指纹，不同 Codex 任务仍保留独立线程、轮次和缓存范围。未配置该字段的存量账号继续按关闭处理，不会被迁移强制开启。',
        codexFingerprintOff: '关闭（原样透传）',
        codexFingerprintDevice: '仅设备',
        codexFingerprintSession: '账号级平衡（推荐）',
        codexFingerprintFull: '完全收敛（实验性）',
      ...
      oauth: {
        ...
        grok: {
          ...
          convertSSOAndReauth: '刷新已有账号',
          uploadSSOFile: '上传 SSO 文件',
          ssoReauthSuccess: 'SSO 刷新完成：更新 {updated}，新建 {created}，失败 {failed}',
          failedToReauthSSO: 'Grok SSO 刷新失败',
          validating: '验证中...',
          validateAndCreate: '验证并创建账号',
          pleaseEnterRefreshToken: '请输入 Refresh Token',
